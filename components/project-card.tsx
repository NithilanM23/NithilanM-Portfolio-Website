        ...
        <div className="relative h-full flex flex-col">
          {image && (
            <div className="relative overflow-hidden h-48">
              <div className="absolute inset-0 bg-gradient-to-b from-orange-500/20 to-amber-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10"></div>
              <img
                src={image}
                alt={title}
          ...
          <div className={`p-6 flex-grow ${!image ? "pt-6" : ""}`}>
            ...
            <div className="flex justify-between mt-auto pt-4 border-t border-zinc-700/50">
              ...
              <Button
                size="sm"
                className="bg-gradient-to-r from-orange-500 to-amber-500 hover:from-amber-500 hover:to-orange-500 border-0"
                asChild
              >
